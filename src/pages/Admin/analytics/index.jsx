...
export default function Analytics() {
    ...
    async (period) => {
      try {
        ...
        if (!monthlyReportPayload.success) {
          throw new Error(
            monthlyReportPayload.message ||
              "Failed to load monthly item report",
          );
        }
  ...
  const trendData = useMemo(() => dashboard?.trend || [], [dashboard?.trend]);
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#FBFBF8_0%,#FFFFFF_45%,#F7F5F0_100%)] px-4 py-6 pb-20 lg:px-8">
              ...
              <table className="w-full text-[12px]">
                <thead>
                  <tr className="border-b border-[#00000012] text-[#0000008C]">
                    ...
                    <th className="px-2 py-2 text-center font-medium uppercase">
                      Sales
                    </th>
                    <th className="px-2 py-2 text-right font-medium uppercase">
                      Revenue
                    </th>
                  </tr>
                </thead>
                  ...
                  {monthlyItemSales.length === 0 ? (
                    ...
                    monthlyItemSales.map((row) => (
                      <tr
                        ...
                        className="border-b border-[#00000008] hover:bg-[#00000003]"
                      >
                        <td className="px-2 py-3">{row.monthLabel}</td>
